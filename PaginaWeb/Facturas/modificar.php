...
<div class="topnav">
  ...
  <div class="login">
    ...
    <?php
        ...
        $consulta=$conexion->query("update compis set nombre='".$_POST['nombre']."', ape1='".$_POST['ape1']."', ape2='".$_POST['ape2']."', 
        direccion='".$_POST['direccion']."', poblacion='".$_POST['poblacion']."', cp='".$_POST['cp']."' where id_alumno='".$_POST['id_alumno']."' ");
